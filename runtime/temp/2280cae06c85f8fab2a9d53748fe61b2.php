<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpStudy\PHPTutorial\WWW\cintong\public/../application/index\view\ry\ry.html";i:1540202235;s:74:"D:\phpStudy\PHPTutorial\WWW\cintong\application\index\view\common\top.html";i:1540358118;s:77:"D:\phpStudy\PHPTutorial\WWW\cintong\application\index\view\common\footer.html";i:1541734077;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="header">
    <div class="inner">
        ...
        <div class="img11">
			...
			<!-- 主题内容 -->
			<div class="banner-dm">
				<img src="/static/index/image/banner_ry.jpg"/>
			</div>
		...
		<!--内容-->
		<!--内容-->
		<div class="main-ry" style="margin-top:50px;">
          ...
          <div class="ry-con">
            ...
            <h1 class="ry-tit"><?php echo $cateInfo['title']; ?></h1>
            <p class="ry-p">
			...
			<?php endforeach; endif; else: echo "" ;endif; 
				...
				{
				echo '<img src="/'.$v['pic'].'" class="ry-img"  data-action="zoom"/>';
				}
				}
				}
				 ?>
      ...
      initMap();
		...
		<script>
			$(".pingmians ul li").hover(function() {
				$(this).find("img").attr("src", "/static/index/image/pingmian1.png")
				$(this).addClass("ons")
			}, function() {
				$(this).find("img").attr("src", "/static/index/image/pingmian.png")
