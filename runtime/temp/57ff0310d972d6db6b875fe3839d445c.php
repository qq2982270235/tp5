<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/test/public/../application/admin/view/erji/add.html";i:1534320822;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <div class="layui-tab-item layui-show layui-anim layui-anim-upbit">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" value="" required lay-verify="required" placeholder="请输入栏目名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="sort" value="100"  placeholder="请输入排序" autocomplete="off" class="layui-input" style="width:60px;">
                    </div>
                </div>
            </div>
            <!--扩展设置-->
            ...
            <!--内容设置-->
            <div class="layui-tab-item layui-anim layui-anim-upbit"> <div class="layui-form-item">
