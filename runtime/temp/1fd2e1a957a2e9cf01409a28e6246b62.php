<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\PHPTutorial\WWW\cintong\public/../application/index\view\ppcy\ppcy.html";i:1540199590;s:74:"D:\phpStudy\PHPTutorial\WWW\cintong\application\index\view\common\top.html";i:1540358118;s:77:"D:\phpStudy\PHPTutorial\WWW\cintong\application\index\view\common\footer.html";i:1541734077;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title>信通太合平面创意</title>
      ...
      <script src="/static/index/js/zooming.js"></script>
		...
		<style>
          ...
          .dm-box ul p {
			...
			width: 300px;height: 100px;line-height: 20px;font-size: 16px;overflow: hidden;-ms-text-overflow: ellipsis;text-overflow: ellipsis;white-space: nowrap; text-align: center;
                margin-left: 35px;
...
<div class="header">
    <div class="inner">
        ...
        <div class="img11">
			...
			<!-- 主题内容 -->
			<div class="banner-dm ">
				<img src="/static/index/image/banner_pp.jpg" data-action="zoom"/>
			</div>
		...
		<div class="_one" style="margin: 0;">
					...
					<ul>
						...
						<a href="<?php  static $i=0;echo $arrPath[$i];  ?>">
							<li class="" id="pmcy" data-pic="/static/index/image/indexIco/nav<?php  static $i=0;echo $i;  ?>.png"  data-pic-a="/static/index/image/indexIco/nav<?php  static $i=0;echo $i;  ?>-h.png">
								<div>
									<img src="/static/index/image/indexIco/nav<?php  static $i=0;echo $i;  ?>.png" data-action="zoom"/>
								</div>
			...
			<!--平面创意-->
			<div class="tiao" id="pmcy-list" style="display: none;">
				<span><a href="#zlzs">VI系统</a></span>
				<span><a href="#wyyc">形象广告</a></span>
				<span><a href="#hyhd">宣传品</a></span>
			</div>
			<!--影视后期-->
			<div class="tiao" id="yshq-list" style="display: none;">
			...
			<!--公关活动-->
			<div class="tiao" id="gghd-list" style="display: none;">
				<span><a href="#zlzs">展览展示</a></span>
				<span><a href="#wyyc">文艺演出</a></span>
				<span><a href="#hyhd">会议活动</a></span>
			</div>
		</div>
      <style>
        .mainTitle{width:100%;}
    ...
    var map;
      initMap();
		...
		<script>
			...
			/*二级菜单*/
			$("#pmcy").mouseover(function(){
			    $("#pmcy-list").show();
			    $("#yshq-list").hide();
			    $("#gghd-list").hide();
			});
			$("#pmcy-list").mouseleave(function(){
			    $("#pmcy-list").hide();
			});
			
			/*第二个*/
			$("#yshq").mouseover(function(){
			    $("#yshq-list").show();
			    $("#pmcy-list").hide();
			    $("#gghd-list").hide();
			});
			$("#yshq-list").mouseleave(function(){
			    $("#yshq-list").hide();
			});
			
			/*第三个*/
			$("#gghd").mouseover(function(){
			    $("#gghd-list").show();
			    $("#pmcy-list").hide();
			    $("#yshq-list").hide();
			});
			$("#gghd-list").mouseleave(function(){
			    $("#gghd-list").hide();
			});
