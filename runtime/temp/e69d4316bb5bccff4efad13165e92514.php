<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\cintong\public/../application/admin\view\article\article_add.html";i:1538990563;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form" action="?" method="post">
            ...
            <div class="layui-input-inline">
                <div class="">
                        ...
                        <select name="cid" required lay-verify="required" lay-filter="lanmu">
                            ...
                            <option value="<?php echo $vo['id']; ?>" data="<?php echo $vo['typeid']; ?>"><?php echo $vo['name']; ?></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item" id="model" style="display:none;">
                ...
                <div class="layui-input-block">
                    <input type="text" name="model" placeholder="请输入内容名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="zhiwu" placeholder="请输入内容信息" autocomplete="off" class="layui-input">
                </div>
            </div>
            </div>
            <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','upload'], function(){
        ...
        form.on('select(lanmu)', function(data){
            ...
            var lmtype=$(data_elem).find('option:selected').attr('data');
