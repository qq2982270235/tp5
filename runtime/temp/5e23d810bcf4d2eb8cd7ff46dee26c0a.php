<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\phpStudy\PHPTutorial\WWW\cintong\public/../application/admin\view\article\article_list.html";i:1533712570;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-container">
    <form action="<?php echo url('article/delall'); ?>" method="post">

        <div>
            <a href="<?php echo url('article/add'); ?>" class="layui-btn layui-btn-normal ">添加内容</a>
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr class="layui-form">
            ...
            <td>
                <botton class="layui-btn layui-btn-mini <?php if($vo['pic'] == '0'): ?> layui-btn-disabled<?php endif; ?> tupian" id="<?php echo $vo['id']; ?>"><i class="layui-icon">&#xe64a;</i>图片</botton>
                <a href="<?php echo url('article/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-warm layui-btn-mini"><i class="layui-icon">&#xe642;</i>编辑</a>
                <a href="<?php echo url('article/del',['aid'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini del"><i class="layui-icon">&#xe640;</i>删除</a></td>
             </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
    </table>
